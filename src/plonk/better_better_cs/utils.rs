...
pub(crate) fn get_degree<E: Engine>(poly: &Polynomial<E, Coefficients>) -> usize {
...
pub(crate) fn calculate_inverse_vanishing_polynomial_with_last_point_cut<E: Engine>(
    worker: &Worker,
    poly_size: usize,
    ...
    let mut numerator = Polynomial::<E, Values>::from_values(vec![coset_factor; poly_size])?;
