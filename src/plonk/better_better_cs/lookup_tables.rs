...
pub const RANGE_CHECK_SINGLE_APPLICATION_TABLE_NAME: &'static str =
    "Range check table for a single column";

pub trait LookupTableInternal<E: Engine>:
    Send + Sync + 'static + std::any::Any + std::fmt::Debug
{
...
impl<E: Engine> LookupTableApplication<E> {
    ...
    pub fn new_range_table_of_width_3(
        width: usize,
        over: Vec<PolyIdentifier>,
    ...
    pub fn new_binop_table<B: Binop>(
        bit_width: usize,
        over: Vec<PolyIdentifier>,
        name: &'static str,
    ) -> Result<Self, SynthesisError> {
...
pub(crate) struct LookupDataHolder<E: Engine> {
    pub(crate) eta: E::Fr,
    pub(crate) f_poly_unpadded_values: Option<Polynomial<E, Values>>,
    pub(crate) t_poly_unpadded_values: Option<Polynomial<E, Values>>,
    pub(crate) t_shifted_unpadded_values: Option<Polynomial<E, Values>>,
    pub(crate) s_poly_unpadded_values: Option<Polynomial<E, Values>>,
    pub(crate) s_shifted_unpadded_values: Option<Polynomial<E, Values>>,
    // pub(crate) f_poly_monomial: Option<Polynomial<E, Coefficients>>,
    pub(crate) t_poly_monomial: Option<Polynomial<E, Coefficients>>,
    pub(crate) s_poly_monomial: Option<Polynomial<E, Coefficients>>,
    pub(crate) selector_poly_monomial: Option<Polynomial<E, Coefficients>>,
    pub(crate) table_type_poly_monomial: Option<Polynomial<E, Coefficients>>,
}
