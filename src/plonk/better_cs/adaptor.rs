        ...
        match (a_is_constant, b_is_constant, c_is_constant) {
            ...
            (true, false, false) | (false, true, false) => {
                ...
                if multiplier == zero_fr {
                    ...
                    let (_, _, hint_c) =
                        enforce_lc_as_gates(self, c_lc, one_fr, c_constant_term, false, &mut space)
...
fn transpile_xor_using_new_adaptor() {
    ...
    let is_valid =
        verify::<Bn256, PlonkCsWidth4WithNextStepParams, Transcr>(&proof, &verification_key, None)
            .unwrap();
...
fn transpile_xor_and_prove_with_no_precomputations() {
    ...
    let proof =
        super::super::prove_by_steps::<_, _, Transcr>(c, &hints, &setup, None, &crs_mons, None)
            .unwrap();
